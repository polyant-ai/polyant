...
export const providerConfigs: Record<string, ProviderConfig> = {
  ...
  nebius: {
    ...
    models: {
      ...
      "Qwen/Qwen3.5-397B-A17B": { input: 0.60, output: 3.60, reasoning: true, vision: false, temperature: true, cache: false },
      "Qwen/Qwen3-Next-80B-A3B-Thinking": { input: 0.15, output: 1.20, reasoning: true, vision: false, temperature: true, cache: false },
      "deepseek-ai/DeepSeek-V4-Pro": { input: 1.75, output: 3.50, reasoning: true, vision: false, temperature: true, cache: false },
      "zai-org/GLM-5.1": { input: 1.40, output: 4.40, reasoning: true, vision: false, temperature: true, cache: false },
      "zai-org/GLM-5.2": { input: 1.40, output: 4.40, reasoning: true, vision: false, temperature: true, cache: false },
      "openai/gpt-oss-120b": { input: 0.15, output: 0.60, reasoning: true, reasoningAlwaysOn: true, vision: false, temperature: true, cache: false },
      "moonshotai/Kimi-K2.7-Code": { input: 0.95, output: 4.00, reasoning: true, vision: false, temperature: true, cache: false },
      "MiniMaxAI/MiniMax-M2.5": { input: 0.30, output: 1.20, reasoning: true, vision: false, temperature: true, cache: false },
      "NousResearch/Hermes-4-70B": { input: 0.13, output: 0.40, reasoning: true, vision: false, temperature: true, cache: false },
      "NousResearch/Hermes-4-405B": { input: 1.00, output: 3.00, reasoning: true, vision: false, temperature: true, cache: false },
      // NVIDIA Nemotron family [R]
      "nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B": { input: 0.06, output: 0.24, reasoning: true, vision: false, temperature: true, cache: false },
      "nvidia/Nemotron-3-Nano-Omni": { input: 0.06, output: 0.24, reasoning: true, vision: false, temperature: true, cache: false },
      "nvidia/nemotron-3-super-120b-a12b": { input: 0.30, output: 0.90, reasoning: true, vision: false, temperature: true, cache: false },
      "nvidia/Llama-3_1-Nemotron-Ultra-253B-v1": { input: 0.60, output: 1.80, reasoning: true, vision: false, temperature: true, cache: false },
      "nvidia/Nemotron-3-Ultra-550b-a55b": { input: 1.00, output: 3.00, reasoning: true, vision: false, temperature: true, cache: false },
      // — Vision-language [V] (also reasoning where noted) —
      "nvidia/Cosmos3-Super-Reasoner": { input: 0.10, output: 0.30, reasoning: true, vision: true, temperature: true, cache: false }, // [R][V]
      "moonshotai/Kimi-K2.6": { input: 0.95, output: 4.00, reasoning: true, vision: true, temperature: true, cache: false }, // [R][V]
