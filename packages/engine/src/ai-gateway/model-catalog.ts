...
export const providerConfigs: Record<string, ProviderConfig> = {
  openai: {
    ...
    models: {
      ...
      "gpt-5.4": { input: 2.50, output: 15.00, cacheRead: 0.25, cacheWrite: 0, reasoning: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
      "gpt-5.4-mini": { input: 0.75, output: 4.50, cacheRead: 0.075, cacheWrite: 0, reasoning: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
      "gpt-5.4-nano": { input: 0.20, output: 1.25, cacheRead: 0.02, cacheWrite: 0, reasoning: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
      ...
      "gpt-5.6-sol": { input: 5.00, output: 30.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
      "gpt-5.6-terra": { input: 2.50, output: 15.00, cacheRead: 0.25, cacheWrite: 3.125, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
      "gpt-5.6-luna": { input: 1.00, output: 6.00, cacheRead: 0.10, cacheWrite: 1.25, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
      ...
      "o3": { input: 2.00, output: 8.00, cacheRead: 1.00, cacheWrite: 0, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: true, temperature: false, cache: true },
    },
  },
  anthropic: {
    tiers: {
    ...
    models: {
      ...
      // Haiku 4.5 (fast)
      "claude-haiku-4-5-20251001": { input: 1.00, output: 5.00, cacheRead: 0.10, cacheWrite: 2.00, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      // Sonnet family (sonnet-5 uses the adaptive thinking API)
      "claude-sonnet-5": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 6.00, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "claude-sonnet-4-6": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 6.00, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "claude-sonnet-4-5-20250929": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 6.00, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      // Opus family (4.7/4.8 use the adaptive thinking API; 4.6 uses legacy budget)
      "claude-opus-4-8": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 10.00, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "claude-opus-4-7": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 10.00, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "claude-opus-4-6": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 10.00, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
    },
  },
  bedrock: {
    ...
    models: {
      ...
      "eu.anthropic.claude-haiku-4-5-20251001-v1:0": { input: 1.00, output: 5.00, cacheRead: 0.10, cacheWrite: 1.25, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "eu.anthropic.claude-sonnet-4-20250514-v1:0": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "eu.anthropic.claude-sonnet-4-5-20250929-v1:0": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "eu.anthropic.claude-sonnet-4-6": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      // ponytail: profile ID follows the sonnet-4-6 form; confirm EU invocability + pricing before promoting to `standard`.
      "eu.anthropic.claude-sonnet-5": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "eu.anthropic.claude-opus-4-5-20251101-v1:0": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "eu.anthropic.claude-opus-4-6-v1": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "eu.anthropic.claude-opus-4-7": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "eu.anthropic.claude-opus-4-8": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      ...
      "global.anthropic.claude-haiku-4-5-20251001-v1:0": { input: 1.00, output: 5.00, cacheRead: 0.10, cacheWrite: 1.25, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "global.anthropic.claude-sonnet-4-5-20250929-v1:0": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "global.anthropic.claude-sonnet-4-6": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "global.anthropic.claude-sonnet-5": { input: 3.00, output: 15.00, cacheRead: 0.30, cacheWrite: 3.75, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "global.anthropic.claude-opus-4-5-20251101-v1:0": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "global.anthropic.claude-opus-4-6-v1": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "budget", vision: true, temperature: true, cache: true },
      "global.anthropic.claude-opus-4-7": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      "global.anthropic.claude-opus-4-8": { input: 5.00, output: 25.00, cacheRead: 0.50, cacheWrite: 6.25, reasoning: true, reasoningControl: "adaptive", vision: true, temperature: false, cache: true },
      ...
      "openai.gpt-oss-20b-1:0": { input: 0.09, output: 0.40, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "openai.gpt-oss-120b-1:0": { input: 0.20, output: 0.79, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      ...
      "minimax.minimax-m2.5": { input: 0.36, output: 1.44, reasoning: true, reasoningControl: "budget", vision: false, temperature: true, cache: false },
    },
  },
  nebius: {
    ...
    models: {
      ...
      "Qwen/Qwen3.5-397B-A17B": { input: 0.60, output: 3.60, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "Qwen/Qwen3-Next-80B-A3B-Thinking": { input: 0.15, output: 1.20, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "deepseek-ai/DeepSeek-V4-Pro": { input: 1.75, output: 3.50, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "zai-org/GLM-5.1": { input: 1.40, output: 4.40, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "zai-org/GLM-5.2": { input: 1.40, output: 4.40, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "openai/gpt-oss-120b": { input: 0.15, output: 0.60, reasoning: true, reasoningAlwaysOn: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "moonshotai/Kimi-K2.7-Code": { input: 0.95, output: 4.00, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "MiniMaxAI/MiniMax-M2.5": { input: 0.30, output: 1.20, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "NousResearch/Hermes-4-70B": { input: 0.13, output: 0.40, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "NousResearch/Hermes-4-405B": { input: 1.00, output: 3.00, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      // NVIDIA Nemotron family [R]
      "nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B": { input: 0.06, output: 0.24, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "nvidia/Nemotron-3-Nano-Omni": { input: 0.06, output: 0.24, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "nvidia/nemotron-3-super-120b-a12b": { input: 0.30, output: 0.90, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "nvidia/Llama-3_1-Nemotron-Ultra-253B-v1": { input: 0.60, output: 1.80, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      "nvidia/Nemotron-3-Ultra-550b-a55b": { input: 1.00, output: 3.00, reasoning: true, reasoningControl: "effort", vision: false, temperature: true, cache: false },
      // — Vision-language [V] (also reasoning where noted) —
      "nvidia/Cosmos3-Super-Reasoner": { input: 0.10, output: 0.30, reasoning: true, reasoningControl: "effort", vision: true, temperature: true, cache: false }, // [R][V]
      "moonshotai/Kimi-K2.6": { input: 0.95, output: 4.00, reasoning: true, reasoningControl: "effort", vision: true, temperature: true, cache: false }, // [R][V]
