...
import { providerConfigs, isThinkingCapable, isReasoningAlwaysOn, clampTemperature, temperatureSupported } from "../../ai-gateway/config.js";
...
export class InstancesController {
  ...
  @Get("models")
  getModels() {
    const providers: Record<string, { models: { id: string; tier: string | null; costInput: number; costOutput: number; supportsThinking: boolean; reasoningAlwaysOn: boolean; supportsTemperature: boolean }[] }> = {};
