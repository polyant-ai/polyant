...
const configSchema = z.object({
  ...
  datetime: z.object({
    // No explicit DATETIME_TIMEZONE → follow the runtime zone (driven by the TZ env var,
    // else the system zone). resolvedOptions() reflects TZ set before Node started.
