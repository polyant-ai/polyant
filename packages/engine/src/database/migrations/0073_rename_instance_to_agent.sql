...
-- commit. The /v1 slug contract is unchanged (slug values are untouched).
--
...
ALTER TABLE principal_secrets   RENAME COLUMN instance_id TO agent_id;
ALTER TABLE oauth_states        RENAME COLUMN instance_id TO agent_id;
